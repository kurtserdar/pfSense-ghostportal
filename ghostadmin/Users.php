...
$ksayisi = mysqli_num_rows (mysqli_query($baglan,"select id from radcheck WHERE  tip='1'   "));

$ssayisi = ceil ($ksayisi/$kacar);

$nereden = ($sayfa*$kacar) -$kacar;

$bul = mysqli_query($baglan,"select * from radcheck WHERE  tip='1' order by id desc limit $nereden,$kacar");
...
$ksayisi = mysqli_num_rows (mysqli_query($baglan,"select id from radcheck WHERE  tip='2'   "));

$ssayisi = ceil ($ksayisi/$kacar);

$nereden = ($sayfa*$kacar) -$kacar;

$bul = mysqli_query($baglan,"select * from radcheck WHERE  tip='2' order by id desc limit $nereden,$kacar");
while ($goster = mysqli_fetch_array($bul)) {
extract ($goster);
...
$ksayisi = mysqli_num_rows (mysqli_query($baglan,"select id from radcheck WHERE  tip='3'   "));

$ssayisi = ceil ($ksayisi/$kacar);

$nereden = ($sayfa*$kacar) -$kacar;
mysqli_query($baglan,"SET NAMES UTF8");
$bul = mysqli_query($baglan,"select * from radcheck WHERE  tip='3' order by id desc limit $nereden,$kacar");
while ($goster = mysqli_fetch_array($bul)) {
extract ($goster);
...
$tcno=$_POST['tcno'];
$dtarih=$_POST['dtarih'];
$degis=mysqli_query($baglan,"UPDATE radcheck SET username='$username',value='$value',adsoyad='$adsoyad',telefon='$telefon',tcno='$tcno',dtarih='$dtarih' WHERE id='$id'   ") or die(mysql_error());
if($degis){
header("location:Message.php?id=Basarili");
