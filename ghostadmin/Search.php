				...
				<th class="table-header-repeat line-left minwidth-1">><a href="">TC KİMLİK</a></th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">TELEFON</a></th>
									<th class="table-header-repeat line-left minwidth-1"><a href="">DOĞUM TARİHİ</a></th>
																		<th class="table-header-repeat line-left minwidth-1"><a href="">ÜYELİK TİPİ</a></th>
...
$ara = $_POST['ara'];
$bul = mysqli_query($baglan,"SELECT * FROM radcheck WHERE  username like '$ara' and attribute='User-Password' ");   
$bulunan=0;
...
<table width="40" border="0">
  <tr>
    <td><form action="Search.php?id=Sonuc" method="POST" >
		<table width="600" border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
	
			<th valign="top">Kullanıcı Adı</th>
			<td width="185"><input type="text" name="ara" required="required" class="inp-form" /></td>
			<td width="21"></td>
		</tr>
