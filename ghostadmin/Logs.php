...
<div id="content">
	...
	<tr>
		<th rowspan="4" class="sized"><img src="images/shared/side_shadowleft.jpg" width="20" height="300" alt="" /></th>
		<th class="topleft"></th>
		<td id="tbl-border-top">&nbsp;</td>
		<th class="topright"></th>
		<th rowspan="4" class="sized"><img src="images/shared/side_shadowright.jpg" width="20" height="300" alt="" /></th>
	</tr>

	<!-- ylmz, kullanici arama -->
	<tr>
	<td id="tbl-border-left"></td>
	<td><form action="Logs.php?id=details" method="POST" >
    ...
    <?php 
		...
		<tr>
			...
			<td colspan="3" width="200"><input type="text" name="userfilter" class="inp-form" value="<?php echo $userfilter; ?>"/></td>
		</tr>
		<tr>
			<td width="10"></td>
			<td width="100"><h4><br>Ip Adresi<h4></td>
			<td width="200"><input type="text" name="ipfilter" class="inp-form" value="<?php echo $ipfilter; ?>"/></td>
			<td width="10"></td>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<tr>
				...
				<th class="table-header-repeat line-left minwidth-1"><a href="">Başlangıç T.</a></th>
...
$countquery=mysqli_query($baglan,"select count(*) as 'reccount' from radacct".$wheretxt);
$ksayisi=mysqli_field_seek($countquery, 0);
// *****************************************************************
...
$bul = mysqli_query($baglan,"select * from radacct ".$wheretxt."order by radacctid desc limit $nereden,$kacar");
...
<?php } ?>
			...
			<!--  start actions-box ............................................... -->
			<div id="actions-box">
				<a href="Save.php?id=RadAcctDelete&userfilter=<?php echo $userfilter ?>&ipfilter=<?php echo $ipfilter ?>" title="Bütün/Filtrelenen logları temizler" onClick="return confirm('Bütün/Filtrelenen logları temizlemekten eminmisin ?')" ><img src="images/sil.png" width="32" height="32" /> </a>
				<div class="clear"></div>
			</div>
			<!-- end actions-box........... -->
...
<div id="content">
	...
	<tr>
	<td id="tbl-border-left"></td>
	<td><form action="Logs.php?id=access" method="POST" >
		<table width="100%" border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr height="60">
			<td width="10"></td>
			<td width="100"><h4><br>Kullanıcı Adı<h4></td>
      <?php $userfilter=trim($_POST['userfilter']); 
			...
			?>
			<td width="100"><input type="text" name="userfilter" class="inp-form" value="<?php echo $userfilter; ?>"/></td>
			<td width="10"></td>
			<td><input type="submit"  class="form-filter" /></td>
		</tr>
		</table>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Kullanıcı Adı</a>	</th>
...
$ksayisi = mysqli_num_rows (mysqli_query($baglan,"select id from radpostauth"));
//$countquery=mysqli_query($baglan,"select count(*) as 'reccount' from radpostauth".$wheretxt);
//$ksayisi=mysqli_result($countquery, 0, 'reccount');
// *****************************************************************
...
$bul = mysqli_query($baglan,"select * from radpostauth".$wheretxt."order by id desc limit $nereden,$kacar");
while ($goster = mysqli_fetch_array($bul)) {
extract ($goster);
...
<?php } ?>
			...
			<!--  start actions-box ............................................... -->
			<div id="actions-box">
				<a href="Save.php?id=PostLogDelete&userfilter=<?php echo $userfilter ?>" title="Bütün/Filtrelenen logları temizler" onClick="return confirm('Bütün/Filtrelenen logları temizlemekten eminmisin ?')" ><img src="images/sil.png" width="32" height="32" /> </a>
				<div class="clear"></div>
			</div>
			<!-- end actions-box........... -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Ad Soyad</a>	</th>
...
$ksayisi = mysqli_num_rows (mysqli_query($baglan,"select id from log"));

$ssayisi = ceil ($ksayisi/$kacar);

$nereden = ($sayfa*$kacar) -$kacar;

$bul = mysqli_query($baglan,"select * from log order by id desc limit $nereden,$kacar");
while ($goster = mysqli_fetch_array($bul)) {
extract ($goster);
...
<?php } ?>
			...
			<!--  start actions-box ............................................... -->
			<div id="actions-box">
				<a href="Save.php?id=SmsLogsDelete" title="Bütün Logları temizler" onClick="return confirm('Bütün logları temizlemekten eminmisin ?')" ><img src="images/sil.png" width="32" height="32" /> </a>
				<div class="clear"></div>
			</div>
			<!-- end actions-box........... -->
