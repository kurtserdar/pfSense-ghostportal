...
if($id == "Password"){
	...
	$sor=mysqli_query($baglan,"SELECT * FROM admin");
	$username=$_POST['username'];
	$password=$_POST['password'];

	$degis=mysqli_query($baglan,"UPDATE ghost_users SET username='$username',password='$password' WHERE id='1' ") or die(mysqli_error($baglan));
	if($degis){
	...
	$sil=mysqli_query($baglan,"DELETE from radpostauth".$wheretxt) or die(mysql_error());	
	if($sil){
	...
	$sil=mysqli_query($baglan,"DELETE from log ") or die(mysql_error());	
	if($sil){
	...
	$sil=mysqli_query($baglan,"DELETE from radacct".$wheretxt) or die(mysql_error());	
	if($sil){
	...
	$sil=mysqli_query($baglan,"DELETE from radcheck WHERE tip='1' ") or die(mysql_error());	
	if($sil){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$sil=mysqli_query($baglan,"DELETE from radcheck WHERE tip='3' ") or die(mysql_error());	
	if($sil){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$sil=mysqli_query($baglan,"DELETE from radcheck WHERE tip='2' ") or die(mysql_error());	
	if($sil){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$sil=mysqli_query($baglan,"DELETE from radreply ") or die(mysql_error());	
	if($sil){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$sil=mysqli_query($baglan,"DELETE from radcheck ") or die(mysql_error());	
	if($sil){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$sor=mysqli_query($baglan,"SELECT * FROM ghost_settings");
	...
	$degis=mysqli_query($baglan,"UPDATE ghost_settings SET passwordexptime='$passwordexptime',smsuser='$smsuser',smspass='$smspass',smsno='$smsno',apiurl='$apiurl'
	...
	$bas=mysqli_query($baglan,"insert into radreply (username,attribute,op,value) values ('$username','$attribute','$op','$value') ") or die(mysql_error());
	if($bas){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$bas=mysqli_query($baglan,"insert into radcheck (username,attribute,op,value) values ('$username','$attribute','$op','$value') ") or die(mysqli_error());
	if($bas){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
	...
	$bas=mysqli_query($baglan,"insert into radcheck (username,attribute,op,value,tip,telefon,tcno,adsoyad) values ('$username','$attribute','$op','$value','$tip','$telefon','$tcno','$adsoyad') ") or die(mysqli_error($baglan));
	if($bas){
		header("location:Message.php?id=Basarili");
	} else {
		header("location:Message.php?id=Hata");
